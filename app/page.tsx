        ...
        <div className="max-w-6xl mx-auto px-4 text-center relative">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="font-inter text-lg md:text-xl text-gray-700 mb-10 max-w-3xl mx-auto">
              Upload your lecture notes, project reports, or posters and get them printed and delivered to your
              doorstep!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/upload"
                className="relative group bg-gradient-to-r from-yellow-400 to-yellow-500 text-gray-900 font-inter text-lg px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
              >
              ...
              <Link
                href="/auth/signup"
                className="relative overflow-hidden bg-white border-2 border-blue-400 text-blue-500 font-inter text-lg px-8 py-4 rounded-xl hover:text-white transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
